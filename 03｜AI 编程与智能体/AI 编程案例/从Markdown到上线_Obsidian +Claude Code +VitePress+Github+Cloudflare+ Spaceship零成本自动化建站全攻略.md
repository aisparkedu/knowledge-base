...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_001.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_002.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_003.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_004.jpg)

依赖安装完毕，可以叫他本地直接跑项目看效果了。

**"你直接给我启动运行本项目"**

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_005.jpg)

看到访问地址基本就OK了，浏览器输入访问看效果。

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_006.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_011.jpg)

点击开始[构建]，进入页面会看到下面 [pages] 点击 [开始使用]

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_012.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_013.jpg)

点击下一步 框架预设：选择VitePress 构建命令： npm vitepress build 构建输出目录：docs/.vitepress/dist

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_014.jpg)

点击保存并部署后，即可看到一个cloudflare送给我们的默认域名。

好了，兄弟们，网站有了。直接进行点击，cloudflare给我们的免费域名

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_015.jpg)

## 6、更新网站内容

直接用下面的提示词修改首页的title。

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_016.jpg)

更新完毕后，直接提交代码

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_017.jpg)

稍等片刻，或者你也可以在cloudflare中查看部署是否完毕

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_018.jpg)

随后刷新浏览器查看我们部署的网页

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_019.jpg)
...
![](assets/TCFfdwXyco65nSxsSMicl44wnxb_023.jpg)

再根据下图操作

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_024.jpg)

点击设置自定义域，输入我们申请的域名，点击继续，再点击激活域。

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_025.jpg)

稍等片刻就可以针对我们上面部署的网站用自己的域名进行访问了。

![](assets/TCFfdwXyco65nSxsSMicl44wnxb_026.jpg)
...
> 来源：飞书 · AI Spark 知识库 ｜ 原文（最新版）：<https://lcnniolukk80.feishu.cn/wiki/CEERwwjshiODs1kuTvcc5FkAnk3> ｜ 归档：2026-06-04
