...
![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_001.jpg)
...
![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_002.jpg)

安装完毕之后就可以进行设置了

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_003.jpg)

这里我选择Quick setup模式

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_004.jpg)

然后进行选择大模型,你可以直接选择Claude、OpenAI等，这里我直接选择OpenAI Codex，这里选择完毕，它直接读取我原来本地的OpenAI Codex的授权配置了，有点方便。

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_005.jpg)

这里如果选择第二个跳过，然后可以直接终端命令行中输入命令hermes，就可以看到如下界面，直接在命令行中进行聊天了。

说明我们的Hermes初步安装完毕。

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_006.jpg)
...
![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_007.jpg)

这里我就选择最简单的Telegram来进行配对, 看下图的1234就知道需要先到Telegram进行配置了。

设置完毕再回来设置这个Bot token

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_008.jpg)

根据上面这个截图的四部开始

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_009.jpg)
...
![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_010.jpg)

这个 user IDs就是前面HTTP API 前面的数字部分，同样复制即可

进入下一步

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_011.jpg)

安装过OpenClaw的可能都熟悉就是要进行配对了

那接下来回到Telegram 工具

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_012.jpg)

点击箭头的链接跳转到聊天机器人

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_013.jpg)

然后复制上面的命令到终端命令行中执行，执行完毕就可以聊天了

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_014.jpg)
...
![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_015.jpg)

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_016.jpg)

## 5、最后

可以使用命令 hermes doctor 进行检查

![](assets/QSc9dzwABoJxkixf02xcj1WEnz8_017.jpg)

还支持从OpenClaw进行迁移配置，很多命令其实跟OpenClaw大同小异。后续将会继续分享关于hermes-agent的精彩内容。

---

> 来源：飞书 · AI Spark 知识库 ｜ 原文（最新版）：<https://lcnniolukk80.feishu.cn/wiki/SCmBwtIk9irtOdkbFQocQHswnHc> ｜ 归档：2026-06-04
