...
![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_001.jpg)

这是这个系列第三篇文章，我会把自己最近从零开始梳理，整理 Mac 使用过程中的经验与步骤记录下来，作为留存与分享。如果拿到一款新的Mac，我最先安装的终端工具就是Ghostty。

我的Mac使用指南系列文章：

- 1、**[Mac使用指南系列文章：Homebrew软件包管理器从入门到精通](Mac使用指南系列文章：Homebrew软件包管理器从入门到精通.md)**
- **2、[Mac使用指南系列文章：从零搭建Codex App桌面端结合GitHub CLI，体验 AI 自动化克隆与提交](Mac使用指南系列文章：从零搭建Codex%20App桌面端结合GitHub%20CLI，体验%20AI%20自动化克隆与提交.md)**
...
![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_002.jpg)

安装完毕，它是一个单独的APP应用，找到它，如果无法打开

![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_003.jpg)

点击右上角❓-> 点击隐私与安全->安全性->点击仍要打开就可以了。

![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_004.jpg)
...
![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_005.jpg)

设置别名完毕，再让他生成一份“适合写代码”的Ghostty初始化配置。

![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_006.jpg)

我暂时就这么用用看，可以双Tab，然后 Command + 1, Command +2 轻松切换Tab。

![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_007.jpg)
...
![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_008.jpg)

![](assets/CFrddCc3hoiciMxzJgrcbFRznZb_009.jpg)

---

> 来源：飞书 · AI Spark 知识库 ｜ 原文（最新版）：<https://lcnniolukk80.feishu.cn/wiki/Bxb2wD7NJiZ6GqkMtzOcluCunvg> ｜ 归档：2026-06-04
